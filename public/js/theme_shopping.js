...
// get shops for shopping
async function loadShopData() {
  // fetch -> HTTP Request (Method: GET + Path: /theme)
  const resp = await fetch('/themeshoppingshop')
...
<!--description-->
  ...
  document.querySelector('#shop-container-1').innerHTML = htmlStr
}


// get secondhand for shopping
async function loadThemeData() {
  // fetch -> HTTP Request (Method: GET + Path: /theme)
  const resp = await fetch('/themeshoppingsecondhand')
...
<!--description-->
  ...
  document.querySelector('#theme-container-1').innerHTML = htmlStr
}

// get blog for living
async function loadBlogData() {
  // fetch -> HTTP Request (Method: GET + Path: /theme)
  const resp = await fetch('/themeshoppingblog')
...
<!--description-->
  ...
  document.querySelector('#blog-container-1').innerHTML = htmlStr
}
