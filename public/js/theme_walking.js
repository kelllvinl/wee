...
async function loadShopData() {
  ...
  const resp = await fetch('/themewalkingshop')
...
<!--description-->
  ...
  document.querySelector('#shop-container-4').innerHTML = htmlStr
}
...
async function loadThemeData() {
  // fetch -> HTTP Request (Method: GET + Path: /theme)
  const resp = await fetch('/themewalkingsecondhand')
...
<!--description-->
  ...
  document.querySelector('#theme-container-4').innerHTML = htmlStr
}

// get blog for living
async function loadBlogData() {
  // fetch -> HTTP Request (Method: GET + Path: /theme)
  const resp = await fetch('/themewalkingblog')
...
<!--description-->
  ...
  document.querySelector('#blog-container-4').innerHTML = htmlStr
}
